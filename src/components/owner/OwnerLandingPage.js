        ...
        <div className="text-center mb-4 sm:mb-6">
          <a href="https://blocapp.ro" className="flex items-center justify-center space-x-2 mb-4 hover:opacity-80 transition-opacity">
            ...
            <div className="flex flex-col items-start pt-2">
              ...
              <span className="text-xs text-gray-600 mt-0 pl-0.5" style={{ fontFamily: 'Montserrat, sans-serif' }}>proprietari</span>
            </div>
          </a>
          <p className="text-gray-500 text-xs">Acces rapid la informațiile apartamentului tău</p>
        </div>
