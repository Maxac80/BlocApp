...
export default function OwnerPaymentsView() {
    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          ...
          <p className="text-sm sm:text-base text-gray-600">Se încarcă datele...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center h-full p-3 sm:p-4 lg:p-6">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Eroare la încărcare</h2>
  ...
  return (
    <div className="p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Plăți</h1>
        <p className="text-sm sm:text-base text-gray-600">Istoricul plăților și plata online</p>
      </div>
      ...
      <div className="bg-gradient-to-r from-emerald-500 to-teal-600 rounded-2xl shadow-lg overflow-hidden">
        <div className="p-4 sm:p-6 text-white">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <div>
              <p className="text-emerald-100 text-xs sm:text-sm">De plată luna curentă</p>
              <p className="text-2xl sm:text-3xl font-bold">{formatCurrency(currentRemaining)}</p>
            </div>
            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-white bg-opacity-20 rounded-xl flex items-center justify-center">
          ...
          {currentDue > 0 && (
            <div className="bg-white bg-opacity-10 rounded-xl p-2.5 sm:p-3 mb-3 sm:mb-4 text-xs sm:text-sm">
          ...
          {currentRemaining > 0 ? (
            <button
              ...
              className="w-full bg-white text-emerald-600 py-3 sm:py-4 rounded-xl font-semibold hover:bg-emerald-50 transition-colors flex items-center justify-center text-sm sm:text-base"
            >
              <CreditCard className="w-4 h-4 sm:w-5 sm:h-5 mr-2" />
              Plătește Online
            </button>
          ) : (
            <div className="bg-white bg-opacity-20 rounded-xl p-3 sm:p-4 flex items-center justify-center text-sm sm:text-base">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <div className="bg-white rounded-xl shadow p-3 sm:p-4">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-base sm:text-lg font-bold text-gray-900">{formatCurrency(totalPaidAllTime)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow p-3 sm:p-4">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-xs sm:text-sm text-gray-500">Nr. plăți</p>
              <p className="text-base sm:text-lg font-bold text-gray-900">{totalPaymentsCount}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow p-3 sm:p-4">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-xs sm:text-sm text-gray-500">Restanțe curente</p>
        ...
        <div className="bg-white rounded-xl shadow p-3 sm:p-4">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-xs sm:text-sm text-gray-500">Penalități curente</p>
      ...
      {totalPaymentsCount > 0 && (
        <div className="bg-white rounded-xl shadow p-3 sm:p-4">
          <h3 className="text-xs sm:text-sm font-medium text-gray-700 mb-2 sm:mb-3">Distribuție plăți efectuate</h3>
          <div className="grid grid-cols-3 gap-2 sm:gap-4">
            <div className="text-center p-2 sm:p-3 bg-blue-50 rounded-lg">
              <p className="text-[10px] sm:text-xs text-blue-600 mb-1">Întreținere</p>
              <p className="text-sm sm:text-lg font-bold text-blue-700">{formatCurrency(totalIntretinerePaid)}</p>
            </div>
            <div className="text-center p-2 sm:p-3 bg-orange-50 rounded-lg">
              <p className="text-[10px] sm:text-xs text-orange-600 mb-1">Restanțe</p>
              <p className="text-sm sm:text-lg font-bold text-orange-700">{formatCurrency(totalRestantePaid)}</p>
            </div>
            <div className="text-center p-2 sm:p-3 bg-red-50 rounded-lg">
              <p className="text-[10px] sm:text-xs text-red-600 mb-1">Penalități</p>
              <p className="text-sm sm:text-lg font-bold text-red-700">{formatCurrency(totalPenalitatiPaid)}</p>
            </div>
          </div>
        </div>
      )}
      ...
      {showPaymentModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-3 sm:p-4 z-50">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
            {/* Header */}
            <div className="bg-gradient-to-r from-emerald-500 to-teal-600 p-4 sm:p-6 text-white text-center">
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="bg-gray-50 rounded-xl p-3 sm:p-4 mb-4 sm:mb-6">
                <div className="flex justify-between items-center mb-2 sm:mb-3">
                  <span className="text-sm sm:text-base text-gray-600">Sumă de plată:</span>
