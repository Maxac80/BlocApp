      ...
      <div className="bg-white shadow-sm border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-lg font-bold text-gray-900">BlocApp</h1>
              <p className="text-xs text-gray-500">Portal Proprietari</p>
            </div>
          </div>
          <button
            onClick={onLogout}
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {apartments.map((apt, index) => (
            <button
              ...
              className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 p-6 text-left group border-2 border-transparent hover:border-emerald-500"
            >
              <div className="flex items-start justify-between">
                ...
                {/* Arrow indicator */}
                <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center group-hover:bg-emerald-500 transition-colors ml-4 flex-shrink-0">
